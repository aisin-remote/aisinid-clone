              ...
              <div class="drawerMenu">
                  ...
                  <nav class="megaNav">
                              ...
                              <div class="megaNavSlide">
                                  <div class="megaNavSlideInner">
                                      ...
                                      <div class="megaNavContent">
                                          <ul>
                                              <li><a href="https://www.aisin.com/en/profile/policy/"
                                                      target="_blank">Corporate Principle</a>
                                              </li>
                                          ...
                                          <ul>
                                              <li><a href="{{ route('management-message') }}">Message from Top
                                                      Management</a></li>
                                              <li><a href="{{ route('executives') }}">Executive Management</a></li>
                                              <li><a href="{{ route('management-policy') }}">Management Policy</a></li>
                                          </ul>
                                          <ul>
                                              <li><a href="https://www.aisin.com/en/profile/brand/"
                                                      target="_blank">Brand</a></li>
                                              <li><a href="https://www.aisin.com/en/profile/global/"
                                                      target="_blank">Global Network</a></li>
                          ...
                          <li class="xxx parent ">
                              ...
                              <div class="megaNavSlide">
                                  <div class="megaNavSlideInner">
                                      ...
                                      <div class="megaNavContent">
                                          <ul>
                                              <li><a href="{{ route('product-list', ['product' => 'body-part']) }}">Body
                                                      Part</a></li>
                                              <li><a href="{{ route('product-list', ['product' => 'engine-part']) }}">Engine
                                                      Part</a></li>
                                              <li><a href="{{ route('product-list', ['product' => 'drive-train']) }}">Drive
                                                      Train</a></li>
                                              <li><a
                                                      href="{{ route('product-list', ['product' => 'electrical-part']) }}">Electronic
                                                      Part</a>
                                              </li>
                                          </ul>
                                      </div><!-- /megaNavContent -->
                      ...
                      <div class="searchBtn view-pc">
                          <a href="javascript:void(0)" class="over"><img
                                  src="{{ asset('website/img/common/ico_search.png') }}" alt=""></a>
                      </div>
